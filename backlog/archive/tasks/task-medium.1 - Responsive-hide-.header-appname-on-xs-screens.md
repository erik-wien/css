...
- Login/reset/impressum etc. pages in Energie/suche that hand-roll `<span class="header-appname">` — the shared CSS rule applies to them automatically since they use the same class.
